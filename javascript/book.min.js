...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(B,u){return"function"==typeof B?function(r){try{m(B(r))}catch(v){p(v)}}:u}var m,p,q=new f(function(B,u){m=B;p=u});this.callWhenSettled_(l(h,m),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
p){function q(r){return function(v){B[r]=v;u--;0==u&&m(B)}}var B=[],u=0;do B.push(void 0),u++,d(l.value).callWhenSettled_(q(B.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
(function(b,c,d,e){function f(n,t,w){return setTimeout(m(n,w),t)}function g(n,t,w){return Array.isArray(n)?(h(n,w[t],w),!0):!1}function h(n,t,w){var A;if(n)if(n.forEach)n.forEach(t,w);else if(n.length!==e)for(A=0;A<n.length;)t.call(w,n[A],A,n),A++;else for(A in n)n.hasOwnProperty(A)&&t.call(w,n[A],A,n)}function k(n,t,w){var A="DEPRECATED METHOD: "+t+"\n"+w+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,A,C);return n.apply(this,arguments)}}function l(n,t,w){t=t.prototype;var A=n.prototype=Object.create(t);A.constructor=n;A._super=t;w&&S(A,w)}function m(n,t){return function(){return n.apply(t,arguments)}}function p(n,t){return"function"==typeof n?n.apply(t?t[0]||e:e,t):n}function q(n,t,w){h(r(t),function(A){"undefined"!=typeof b.addEventListener?n.addEventListener(A,w,!1):n.attachEvent(A,w)})}
function B(n,t,w){h(r(t),function(A){"undefined"!=typeof b.removeEventListener?n.removeEventListener(A,w,!1):n.detachEvent(A,w,!1)})}function u(n,t){for(;n;){if(n==t)return!0;n=n.parentNode}return!1}function r(n){return n.trim().split(/\s+/g)}function v(n,t,w){if(n.indexOf&&!w)return n.indexOf(t);for(var A=0;A<n.length;){if(w&&n[A][w]==t||!w&&n[A]===t)return A;A++}return-1}function x(n){return Array.prototype.slice.call(n,0)}function y(n,t,w){for(var A=[],C=[],D=0;D<n.length;){var E=t?n[D][t]:n[D];
0>v(C,E)&&A.push(n[D]);C[D]=E;D++}w&&(A=t?A.sort(function(J,P){return J[t]>P[t]}):A.sort());return A}function z(n,t){if(t&&t[0]){for(var w,A=t[0].toUpperCase()+t.slice(1),C=0;C<oa.length;){w=(w=oa[C])?w+A:t;if(w in n)return w;C++}return e}}function G(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function F(n,t){var w=this;this.manager=n;this.callback=t;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(A){p(n.options.enable,[n])&&w.handler(A)};this.init()}
function O(n,t,w){var A=w.pointers.length,C=w.changedPointers.length;var D=t&1&&0===A-C;w.isFirst=!!D;w.isFinal=!!(t&12&&0===A-C);D&&(n.session={});w.eventType=t;t=n.session;A=w.pointers;C=A.length;t.firstInput||(t.firstInput=L(w));1<C&&!t.firstMultiple?t.firstMultiple=L(w):1===C&&(t.firstMultiple=!1);D=t.firstInput;var E=(C=t.firstMultiple)?C.center:D.center;var J=w.center=H(A);w.timeStamp=fa();w.deltaTime=w.timeStamp-D.timeStamp;w.angle=M(E,J);w.distance=K(E,J);D=w.center;E=t.offsetDelta||{};J=
t.prevDelta||{};var P=t.prevInput||{};if(1===w.eventType||4===P.eventType)J=t.prevDelta={x:P.deltaX||0,y:P.deltaY||0},E=t.offsetDelta={x:D.x,y:D.y};w.deltaX=J.x+(D.x-E.x);w.deltaY=J.y+(D.y-E.y);w.offsetDirection=I(w.deltaX,w.deltaY);E=w.deltaTime;D=w.deltaX/E||0;E=w.deltaY/E||0;w.overallVelocityX=D;w.overallVelocityY=E;w.overallVelocity=V(D)>V(E)?D:E;C?(D=C.pointers,D=K(A[0],A[1],Y)/K(D[0],D[1],Y)):D=1;w.scale=D;C?(C=C.pointers,A=M(A[1],A[0],Y)+M(C[1],C[0],Y)):A=0;w.rotation=A;w.maxPointers=t.prevInput?
w.pointers.length>t.prevInput.maxPointers?w.pointers.length:t.prevInput.maxPointers:w.pointers.length;E=t.lastInterval||w;A=w.timeStamp-E.timeStamp;8!=w.eventType&&(25<A||E.velocity===e)?(D=w.deltaX-E.deltaX,E=w.deltaY-E.deltaY,J=D/A||0,P=E/A||0,A=J,C=P,J=V(J)>V(P)?J:P,D=I(D,E),t.lastInterval=w):(J=E.velocity,A=E.velocityX,C=E.velocityY,D=E.direction);w.velocity=J;w.velocityX=A;w.velocityY=C;w.direction=D;t=n.element;u(w.srcEvent.target,t)&&(t=w.srcEvent.target);w.target=t;n.emit("hammer.input",w);
n.recognize(w);n.session.prevInput=w}function L(n){for(var t=[],w=0;w<n.pointers.length;)t[w]={clientX:X(n.pointers[w].clientX),clientY:X(n.pointers[w].clientY)},w++;return{timeStamp:fa(),pointers:t,center:H(t),deltaX:n.deltaX,deltaY:n.deltaY}}function H(n){var t=n.length;if(1===t)return{x:X(n[0].clientX),y:X(n[0].clientY)};for(var w=0,A=0,C=0;C<t;)w+=n[C].clientX,A+=n[C].clientY,C++;return{x:X(w/t),y:X(A/t)}}function I(n,t){return n===t?1:V(n)>=V(t)?0>n?2:4:0>t?8:16}function K(n,t,w){w||(w=pa);var A=
t[w[0]]-n[w[0]];n=t[w[1]]-n[w[1]];return Math.sqrt(A*A+n*n)}function M(n,t,w){w||(w=pa);return 180*Math.atan2(t[w[1]]-n[w[1]],t[w[0]]-n[w[0]])/Math.PI}function W(){this.evEl=za;this.evWin=Aa;this.pressed=!1;F.apply(this,arguments)}function Z(){this.evEl=qa;this.evWin=ra;F.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function aa(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;F.apply(this,arguments)}function T(){this.evTarget=
Ba;this.targetIds={};F.apply(this,arguments)}function U(n,t){var w=x(n.touches),A=this.targetIds;if(t&3&&1===w.length)return A[w[0].identifier]=!0,[w,w];n=x(n.changedTouches);var C=[],D=this.target;var E=w.filter(function(J){return u(J.target,D)});if(1===t)for(w=0;w<E.length;)A[E[w].identifier]=!0,w++;for(w=0;w<n.length;)A[n[w].identifier]&&C.push(n[w]),t&12&&delete A[n[w].identifier],w++;if(C.length)return[y(E.concat(C),"identifier",!0),C]}function ha(){F.apply(this,arguments);var n=m(this.handler,
this);this.touch=new T(this.manager,n);this.mouse=new W(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function sa(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var t={x:n.clientX,y:n.clientY};this.lastTouches.push(t);var w=this.lastTouches;setTimeout(function(){var A=w.indexOf(t);-1<A&&w.splice(A,1)},2500)}}function ia(n,t){this.manager=n;this.set(t)}function Ca(n){if(-1<n.indexOf("none"))return"none";var t=-1<n.indexOf("pan-x"),w=-1<n.indexOf("pan-y");return t&&w?"none":
...
this.options.inputTarget||n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new ha(this,O);this.touchAction=new ia(this,this.options.touchAction);va(this,!0);h(this.options.recognizers,function(w){var A=this.add(new w[0](w[1]));w[2]&&A.recognizeWith(w[2]);w[3]&&A.requireFailure(w[3])},this)}function va(n,t){var w=n.element;if(w.style){var A;h(n.options.cssProps,function(C,D){A=z(w.style,D);t?(n.oldCssProps[A]=w.style[A],w.style[A]=C):w.style[A]=n.oldCssProps[A]||
""});t||(n.oldCssProps={})}}function Ea(n,t){var w=c.createEvent("Event");w.initEvent(n,!0,!0);w.gesture=t;t.target.dispatchEvent(w)}var oa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),X=Math.round,V=Math.abs,fa=Date.now;var S="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var t=Object(n),w=1;w<arguments.length;w++){var A=arguments[w];if(A!==e&&null!==A)for(var C in A)A.hasOwnProperty(C)&&(t[C]=A[C])}return t}:
Object.assign;var wa=k(function(n,t,w){for(var A=Object.keys(t),C=0;C<A.length;){if(!w||w&&n[A[C]]===e)n[A[C]]=t[A[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,t){return wa(n,t,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;z(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var pa=["x","y"],Y=["clientX","clientY"];F.prototype={handler:function(){},init:function(){this.evEl&&q(this.element,this.evEl,this.domHandler);this.evTarget&&
...
n.concat(t.getTouchAction()))});return Ca(n.join(" "))},preventDefaults:function(n){var t=n.srcEvent,w=n.offsetDirection;if(this.manager.session.prevented)t.preventDefault();else{var A=this.actions,C=-1<A.indexOf("none")&&!ea.none,D=-1<A.indexOf("pan-y")&&!ea["pan-y"];A=-1<A.indexOf("pan-x")&&!ea["pan-x"];if(C){var E=2>n.distance,J=250>n.deltaTime;if(1===n.pointers.length&&E&&J)return}if(!A||!D)if(C||D&&w&6||A&&w&24)return this.preventSrc(t)}},preventSrc:function(n){this.manager.session.prevented=
...
var t=this.requireFail;n=ba(n,this);-1===v(t,n)&&(t.push(n),n.requireFailure(this));return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=ba(n,this);n=v(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function t(C){w.manager.emit(C,n)}var w=this,A=this.state;8>A&&t(w.options.event+ta(A));t(w.options.event);
n.additionalEvent&&t(n.additionalEvent);8<=A&&t(w.options.event+ta(A))},tryEmit:function(n){if(this.canEmit())return this.emit(n);this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=S({},n);p(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};
l(N,Q,{defaults:{pointers:1},attrTest:function(n){var t=this.options.pointers;return 0===t||n.pointers.length===t},process:function(n){var t=this.state,w=n.eventType,A=t&6;n=this.attrTest(n);return A&&(w&8||!n)?t|16:A||n?w&4?t|8:t&2?t|4:2:32}});l(ca,N,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,t=[];n&6&&t.push("pan-y");n&24&&t.push("pan-x");return t},directionTest:function(n){var t=this.options,w=!0,A=n.distance,C=n.direction,
D=n.deltaX,E=n.deltaY;C&t.direction||(t.direction&6?(C=0===D?1:0>D?2:4,w=D!=this.pX,A=Math.abs(n.deltaX)):(C=0===E?1:0>E?8:16,w=E!=this.pY,A=Math.abs(n.deltaY)));n.direction=C;return w&&A>t.threshold&&C&t.direction},attrTest:function(n){return N.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var t=ua(n.direction);t&&(n.additionalEvent=this.options.event+t);this._super.emit.call(this,n)}});l(ja,N,{defaults:{event:"pinch",
threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ka,Q,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var t=this.options,w=n.pointers.length===t.pointers,A=n.distance<
t.threshold,C=n.deltaTime>t.time;this._input=n;if(!A||!w||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),this._timer=f(function(){this.state=8;this.tryEmit()},t.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=fa(),this.manager.emit(this.options.event,this._input)))}});l(la,N,{defaults:{event:"rotate",threshold:0,
...
n)&&t&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&V(w)>this.options.velocity&&n.eventType&4},emit:function(n){var t=ua(n.offsetDirection);t&&this.manager.emit(this.options.event+t,n);this.manager.emit(this.options.event,n)}});l(da,Q,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var t=this.options,w=n.pointers.length===t.pointers,A=n.distance<
t.threshold,C=n.deltaTime<t.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(A&&C&&w){if(4!=n.eventType)return this.failTimeout();w=this.pTime?n.timeStamp-this.pTime<t.interval:!0;A=!this.pCenter||K(this.pCenter,n.center)<t.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=A&&w?this.count+1:1;this._input=n;if(0===this.count%t.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},t.interval,this),2):8}return 32},
...
A=t.curRecognizer;if(!A||A&&A.state&8)A=t.curRecognizer=null;for(var C=0;C<w.length;){var D=w[C];2===t.stopped||A&&D!=A&&!D.canRecognizeWith(A)?D.reset():D.recognize(n);!A&&D.state&14&&(A=t.curRecognizer=D);C++}}},get:function(n){if(n instanceof Q)return n;for(var t=this.recognizers,w=0;w<t.length;w++)if(t[w].options.event==n)return t[w];return null},add:function(n){if(g(n,"add",this))return this;var t=this.get(n.options.event);t&&this.remove(t);this.recognizers.push(n);n.manager=this;this.touchAction.update();
return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var t=this.recognizers;n=v(t,n);-1!==n&&(t.splice(n,1),this.touchAction.update())}return this},on:function(n,t){if(n!==e&&t!==e){var w=this.handlers;h(r(n),function(A){w[A]=w[A]||[];w[A].push(t)});return this}},off:function(n,t){if(n!==e){var w=this.handlers;h(r(n),function(A){t?w[A]&&w[A].splice(v(w[A],t),1):delete w[A]});return this}},emit:function(n,t){this.options.domEvents&&Ea(n,t);var w=this.handlers[n]&&this.handlers[n].slice();
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,p=0,q=0;f.animateInterval=function(B,u){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*(g-1),20);p=$.easing.swing(null,m,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var r=0;r<f.side.pageArray.length;r++)if(f.side.pageArray[r])f.side.pageArray[r].onResize(k/2,l);m++;if(20<=m||B>=u){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
...
(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var m=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,q=e*k,B=0,u=0,r=0,v=0;toolBar&&(B=0===toolBar.getTopHeight()?
...
u,d=-m-k*e*d.parameters.zoomArea.top/100+B):(h=-m-k*e*d.parameters.zoomArea.top/100+B,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-u);g=Number.between(g,x,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){m(p,q,"Sine")}).animation(this,300)}.bind(this),m=function(p,q,B){if(p<q){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var u=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=p;q.tran={x:B,
y:u};B=transformCSS(q);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),p=getHost();if(m&&p!==m){if(g=f.src.replace(m,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(v){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),B=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var u=Color(b).split();k=0;for(var r=q.data.length;k<r;k+=4)0<B.data[k+3]&&(q.data[k]!=u.r&&(B.data[k]=q.data[k]/255*u.r),q.data[k+1]!=u.g&&(B.data[k+1]=
q.data[k+1]/255*u.g),q.data[k+2]!=u.b&&(B.data[k+2]=q.data[k+2]/255*u.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(v){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(x){}})}}}}};
...
!0;m=new Date;r=(m-l)/20;var v=h-f,x=k-g;0==r?u=B=0:(B=v/r,u=x/r);void 0!=b&&b(B,u);window.clearInterval(p);p=-1}var f,g,h,k,l,m,p=-1,q=!1,B=0,u=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(r){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(r){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",p=-1,q,B,u,r=k.length-l;++p<r;)q=k.charCodeAt(p)<<
16,B=k.charCodeAt(++p)<<8,u=k.charCodeAt(++p),q=q+B+u,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,B=k.charCodeAt(++p),q+=B,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,p,q,B="",u=-1;++u<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(u)),
p=m%4?64*p+q:q,m++%4&&(B+=String.fromCharCode(255&p>>(-2*m&6)));return B},version:"0.1.0"};if("function"==typeof define&&"object"==typeof define.amd&&define.amd)define(function(){return g});else if(c&&!c.nodeType)if(d)d.exports=g;else for(var h in g)g.hasOwnProperty(h)&&(c[h]=g[h]);else b.base64=g})(this);function parsHexToNormalString(b){for(var c="";2<=b.length;)c+=String.fromCharCode(parseInt(b.substring(0,2),16)),b=b.substring(2,b.length);return c}
...
(function(b){function c(u,r){var v=(u&65535)+(r&65535);return(u>>16)+(r>>16)+(v>>16)<<16|v&65535}function d(u,r,v,x,y,z){u=c(c(r,u),c(x,z));return c(u<<y|u>>>32-y,v)}function e(u,r,v,x,y,z,G){return d(r&v|~r&x,u,r,y,z,G)}function f(u,r,v,x,y,z,G){return d(r&x|v&~x,u,r,y,z,G)}function g(u,r,v,x,y,z,G){return d(v^(r|~x),u,r,y,z,G)}function h(u,r){u[r>>5]|=128<<r%32;u[(r+64>>>9<<4)+14]=r;var v=1732584193,x=-271733879,y=-1732584194,z=271733878;for(r=0;r<u.length;r+=16){var G=v;var F=x;var O=y;var L=z;
v=e(v,x,y,z,u[r],7,-680876936);z=e(z,v,x,y,u[r+1],12,-389564586);y=e(y,z,v,x,u[r+2],17,606105819);x=e(x,y,z,v,u[r+3],22,-1044525330);v=e(v,x,y,z,u[r+4],7,-176418897);z=e(z,v,x,y,u[r+5],12,1200080426);y=e(y,z,v,x,u[r+6],17,-1473231341);x=e(x,y,z,v,u[r+7],22,-45705983);v=e(v,x,y,z,u[r+8],7,1770035416);z=e(z,v,x,y,u[r+9],12,-1958414417);y=e(y,z,v,x,u[r+10],17,-42063);x=e(x,y,z,v,u[r+11],22,-1990404162);v=e(v,x,y,z,u[r+12],7,1804603682);z=e(z,v,x,y,u[r+13],12,-40341101);y=e(y,z,v,x,u[r+14],17,-1502002290);
x=e(x,y,z,v,u[r+15],22,1236535329);v=f(v,x,y,z,u[r+1],5,-165796510);z=f(z,v,x,y,u[r+6],9,-1069501632);y=f(y,z,v,x,u[r+11],14,643717713);x=f(x,y,z,v,u[r],20,-373897302);v=f(v,x,y,z,u[r+5],5,-701558691);z=f(z,v,x,y,u[r+10],9,38016083);y=f(y,z,v,x,u[r+15],14,-660478335);x=f(x,y,z,v,u[r+4],20,-405537848);v=f(v,x,y,z,u[r+9],5,568446438);z=f(z,v,x,y,u[r+14],9,-1019803690);y=f(y,z,v,x,u[r+3],14,-187363961);x=f(x,y,z,v,u[r+8],20,1163531501);v=f(v,x,y,z,u[r+13],5,-1444681467);z=f(z,v,x,y,u[r+2],9,-51403784);
y=f(y,z,v,x,u[r+7],14,1735328473);x=f(x,y,z,v,u[r+12],20,-1926607734);v=d(x^y^z,v,x,u[r+5],4,-378558);z=d(v^x^y,z,v,u[r+8],11,-2022574463);y=d(z^v^x,y,z,u[r+11],16,1839030562);x=d(y^z^v,x,y,u[r+14],23,-35309556);v=d(x^y^z,v,x,u[r+1],4,-1530992060);z=d(v^x^y,z,v,u[r+4],11,1272893353);y=d(z^v^x,y,z,u[r+7],16,-155497632);x=d(y^z^v,x,y,u[r+10],23,-1094730640);v=d(x^y^z,v,x,u[r+13],4,681279174);z=d(v^x^y,z,v,u[r],11,-358537222);y=d(z^v^x,y,z,u[r+3],16,-722521979);x=d(y^z^v,x,y,u[r+6],23,76029189);v=d(x^
y^z,v,x,u[r+9],4,-640364487);z=d(v^x^y,z,v,u[r+12],11,-421815835);y=d(z^v^x,y,z,u[r+15],16,530742520);x=d(y^z^v,x,y,u[r+2],23,-995338651);v=g(v,x,y,z,u[r],6,-198630844);z=g(z,v,x,y,u[r+7],10,1126891415);y=g(y,z,v,x,u[r+14],15,-1416354905);x=g(x,y,z,v,u[r+5],21,-57434055);v=g(v,x,y,z,u[r+12],6,1700485571);z=g(z,v,x,y,u[r+3],10,-1894986606);y=g(y,z,v,x,u[r+10],15,-1051523);x=g(x,y,z,v,u[r+1],21,-2054922799);v=g(v,x,y,z,u[r+8],6,1873313359);z=g(z,v,x,y,u[r+15],10,-30611744);y=g(y,z,v,x,u[r+6],15,-1560198380);
x=g(x,y,z,v,u[r+13],21,1309151649);v=g(v,x,y,z,u[r+4],6,-145523070);z=g(z,v,x,y,u[r+11],10,-1120210379);y=g(y,z,v,x,u[r+2],15,718787259);x=g(x,y,z,v,u[r+9],21,-343485551);v=c(v,G);x=c(x,F);y=c(y,O);z=c(z,L)}return[v,x,y,z]}function k(u){var r,v="",x=32*u.length;for(r=0;r<x;r+=8)v+=String.fromCharCode(u[r>>5]>>>r%32&255);return v}function l(u){var r,v=[];v[(u.length>>2)-1]=void 0;for(r=0;r<v.length;r+=1)v[r]=0;var x=8*u.length;for(r=0;r<x;r+=8)v[r>>5]|=(u.charCodeAt(r/8)&255)<<r%32;return v}function m(u){return k(h(l(u),
8*u.length))}function p(u,r){var v=l(u),x=[],y=[];x[15]=y[15]=void 0;16<v.length&&(v=h(v,8*u.length));for(u=0;16>u;u+=1)x[u]=v[u]^909522486,y[u]=v[u]^1549556828;r=h(x.concat(l(r)),512+8*r.length);return k(h(y.concat(r),640))}function q(u){var r="",v;for(v=0;v<u.length;v+=1){var x=u.charCodeAt(v);r+="0123456789abcdef".charAt(x>>>4&15)+"0123456789abcdef".charAt(x&15)}return r}function B(u,r,v){r?v?u=p(unescape(encodeURIComponent(r)),unescape(encodeURIComponent(u))):(u=p(unescape(encodeURIComponent(r)),
unescape(encodeURIComponent(u))),u=q(u)):u=v?m(unescape(encodeURIComponent(u))):q(m(unescape(encodeURIComponent(u))));return u}"function"===typeof define&&define.amd?define(function(){return B}):"object"===typeof module&&module.exports?module.exports=B:b.md5=B})(this);String.prototype.MD5=function(b){return md5(this)};
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this,m=d(h);e[m]&&clearTimeout(e[m]);return new Promise(function(p,q){f[m]||(f[m]=[]);f[m].push({resolve:p,reject:q});e[m]=setTimeout(function(){var B,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){switch(r.nextAddress){case 1:return r.setCatchFinallyBlocks(2,3),r.yield(b.apply(l,h),5);case 5:B=r.yieldResult,f[m].forEach(function(v){return v.resolve(B)});
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d");l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var p=m.getImageData(0,0,l.width,l.height),q=p.data,B=c?e(c):null,u=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<q.length;r+=4){var v=q[r+3];0===v?(q[r]=u.r,q[r+1]=u.g,q[r+2]=u.b,q[r+3]=void 0!==u.a?u.a:0):0<v&&255>v?B&&(q[r]=Math.round((B.r*v+u.r*(255-v))/255),q[r+1]=Math.round((B.g*v+u.g*(255-v))/255),q[r+2]=Math.round((B.b*v+u.b*(255-v))/255),q[r+3]=255):B&&(q[r]=B.r,
q[r+1]=B.g,q[r+2]=B.b,q[r+3]=void 0!==B.a?B.a:255)}m.putImageData(p,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}
...
function(h,k){var l;return $jscomp.asyncExecutePromiseGeneratorProgram(function(m){l=function(){var p,q,B,u,r,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){switch(x.nextAddress){case 1:e=h;if(p="undefined"!==typeof location&&"file:"===location.protocol){x.jumpTo(2);break}x.setCatchFinallyBlocks(3);return x.yield(fetch(k),5);case 5:q=x.yieldResult;if(!q.ok){console.warn("fetch returned non-ok",q.status,k);x.jumpTo(6);break}return x.yield(q.text(),7);case 7:return B=x.yieldResult,
u=B.match(/positionForPages\[(\d+)\]/),r=B,u&&(r=r.replace(new RegExp("positionForPages\\["+u[1]+"\\]","g"),"positionForPages["+(h-1)+"]")),r=r.replace(/("page"\s*:\s*)"?\d+"?/g,"$1"+h),(new Function(r))(),e=null,x.return();case 6:x.leaveTryBlock(2);break;case 3:v=x.enterCatchBlock(),console.warn("fetch failed, fallback to script tag (likely file://). Error:",v&&v.message);case 2:return x.yield(new Promise(function(y,z){var G=document.createElement("script");G.dataset.positionSource=k;G.onload=function(){setTimeout(function(){e=
null;y()},0)};G.onerror=function(F){e=null;console.log("Script load failed:",k,F);z(Error("Script load failed: "+k))};G.src=k;document.head.appendChild(G)}),0)}})};f=f.then(function(){return l()}).catch(function(p){console.log("loadAndFixPositionScript queue error:",p)});return m.return(f)})}})(window);
...
vimeoPlayerUrl="https://player.vimeo.com/api/player.js",cMapUrl="https://unpkg.com/pdfjs-dist@latest/cmaps/",restrictedMap={"aU3e!G7sD":"","qR2j^H5fZ":"loadingPicture","bJ8w&K3tP":"loadingVideo","dT9e#X1sC":"googleAnalyticsID","yO4u*L2xF":"AnnotationButtonVisible","nL7j@V5rB":"aboutButtonVisible","tT3e&Z4yC":"HomeButtonVisible","hY6w%P9gD":"HomeURL","kA8q!R5jH":"googleTagManagerID","eX1z@S8kT":"language","cK5t#D2fP":"BookMarkButtonVisible","jN2z^W8hS":"TableOfContentButtonVisible","rF6e&K4bJ":"PhoneButtonVisible",
zC9u$P3lF:"LeftShadowWidth;LeftShadowAlpha;RightShadowWidth;RightShadowAlpha;ShowTopLeftShadow;pageHighlightType;","wV5t#G1nQ":"thicknessWidthType;thicknessColor","gF4w!D1qR":"haveAdSense","hJ5m#L3dT":"staticAd","xY4z9F@kL":"appLogoIcon","vA6qM8!bN":"appLogoLinkURL"},specialHandlers={appLogoIcon:function(){return"../../booklogo.png"},appLogoLinkURL:function(){return"https://fliphtml5.com"},staticAd:function(){return!0},language:function(){var b,c,d=(null==(b=window.bookConfig)?void 0:b.language)||
(null==(c=window.tmpBookConfig)?void 0:c.language)||"English";return d.includes(";")?d.split(";")[0]:d}};function checkPermission(b,c){if(!c)return!1;for(var d in restrictedMap)if(c.includes(d)&&restrictedMap[d].split(";").includes(b))return!0;return!1}
...
("undefined"!==typeof c?c:"")).trim(),/(^|[\\\/])booklogo\.png(\?.*)?(#.*)?$/i.test(r)))return""},m,p,q,B,u;if((null==(m=window.tmpBookConfig)?0:null==(p=m.power_info)?0:p.power)||(null==(q=window.bookConfig)?0:null==(B=q.power_info)?0:B.power)||(null==(u=window.userInfo)?0:u.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(k());window.eventEmitter.on("loadUserInfo",function(r){return l(k())})}
...
getConfigValue("isMouseEnterToDisplayArticleTitle",!1);tmpBookConfig.delayToFlipFirst=getConfigValue("delayToFlipFirst",!1);tmpBookConfig.timeToFlipFirst=getConfigValue("timeToFlipFirst",10);tmpBookConfig.printBackgroundPosition=getConfigValue("printBackgroundPosition","fit");try{if(window.ignoreModuleArray&&window.ignoreModuleArray.bookConfig)for(e=0;e<window.ignoreModuleArray.bookConfig.length;e++)f=window.ignoreModuleArray.bookConfig[e],void 0!=tmpBookConfig[f]&&(tmpBookConfig[f]=!1)}catch(l){}checkFliphtml5PagesConfig();
checkFlipStyleConfig();return"issuu"==tmpBookConfig.FlipStyle?k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/issuubook.min.css"),7):k.yield(loadCSS(tmpBookConfig.UIBaseURL+"style/flipbook.min.css"),7);case 7:checkPageEditorConfig(),recordError(),g=Module._getVerifyString(),h=UTF8ToString(g),Module._free(g),eval(h),k.jumpToEnd()}})};
...
e=Math.max(e,p)}tmpBookConfig.topMargin=e;var q=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;c&&1==global.staticAd.adPosition&&q<d+20&&(q+=d+20);tmpBookConfig.bottomMargin=q;b.disableResize||"function"!=typeof global.onStageResize||onStageResize()}catch(B){console.log("setBookVerticalMargin error",B)}}
...
(function(){function b(l){l+="=";for(var m=decodeURIComponent(document.cookie).split(";"),p=0;p<m.length;p++){var q=m[p].trim();if(0===q.indexOf(l))return JSON.parse(q.substring(l.length))}return null}function c(l,m){var p=new Date;p.setTime(p.getTime()+31536E8);document.cookie=l+"="+m+";expires="+p.toUTCString()+(";domain="+("Chinese"==UserGroups?".yunzhan365.com":".fliphtml5.com")+";path=/")}function d(){for(var l={},m=window.location.search.substring(1).split("&"),p=0;p<m.length;p++){var q=m[p].split("="),
B=decodeURIComponent(q[0]);q=q[1]?decodeURIComponent(q[1]):null;l[B]=q}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var m=16*Math.random()|0;return("x"===l?m:m&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,page:window.location.href,time:(new Date).getTime(),uuid:g},k=d();k.source?h.channel=k.source:k.i?h.channel="invite_code":k.utm_code?h.channel=k.utm_code:1===Object.keys(k).length&&
null===Object.values(k)[0]&&(h.channel=Object.keys(k)[0]);c("first_visit_channel_source",JSON.stringify(h))}}catch(l){}})();
var VERSION_NAME="6.4.9",BUILD_DATE="2025092901",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
function getArticleEditor(){function b(v){if(window.isExecuteGetInverseEditor)var x=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(x),v()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),v(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(y){d(y,v)},v,"")}function c(v,x,y,z,G){var F=new XMLHttpRequest;F.responseType=
void 0===z?"json":z;F.open("GET",v);F.send();F.onreadystatechange=function(){4===F.readyState&&(200===F.status||304===F.status?x&&x(F):"bookinfo"===G&&x?x():y&&y(x))};F.error=function(){y&&y(x)}}function d(v,x){r&&(clearTimeout(r),r=null);if(window.Module.isReady){var y=allocateUTF8(v.responseText),z=Module._DeString(y),G=UTF8ToString(z);G=eval(G);Module._free(y);Module._FreeMemory(z);e(G);x();window.runArticleEditor&&delete window.runArticleEditor}else r=setTimeout(function(){d(v,x)},100)}function e(v){(window.articleListConfig=
v)?g(v):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(v){window.articleConfig=v.response})}function g(v){for(var x=[],y=window.bookConfig.totalPageCount,z=window.htmlConfig?window.htmlConfig.search_pages:[],G=0;G<y;G++){for(var F=z&&z.length&&z[G]?z[G].index:G,O=[],L=0;L<v.length;L++)(v[L].articles?v[L].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
...
(x.text=x.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return x});return{articleId:v.articleId,newTime:v.newTime,title:v.title,subTitle:v.subTitle,author:v.author,categoryId:v.categoryId,articleTextList:v.articleTextList}}function l(v,x){var y=[];v.forEach(function(z){-1!==x&&(z.pageIndex===x||z.mergeList&&z.mergeList.length&&z.mergeList.filter(function(G){return G.pageIndex===x}).length)&&(z.mergeList&&z.mergeList.length?(z=l(z.mergeList,x),z.length&&(y=[].concat($jscomp.arrayFromIterable(y),$jscomp.arrayFromIterable(z)))):
y.push(z.rect))});return y}function m(v,x){var y="";v.forEach(function(z){if(-1!==x&&(z.pageIndex===x||z.mergeList&&z.mergeList.length&&z.mergeList.filter(function(F){return F.pageIndex===x}).length))if(""===y)y=z.mergeList&&z.mergeList.length?m(z.mergeList,x):JSON.parse(JSON.stringify(z));else{if(z.mergeList&&z.mergeList.length){var G=[y].concat(z.mergeList);y=m(G,x)}y.rect.x>z.rect.x&&(y.rect.x=z.rect.x);y.rect.y>z.rect.y&&(y.rect.y=z.rect.y);y.rect.endX<z.rect.endX&&(y.rect.endX=z.rect.endX);y.rect.endY<
z.rect.endY&&(y.rect.endY=z.rect.endY);y.rect.width=y.rect.endX-y.rect.x;y.rect.height=y.rect.endY-y.rect.y}});return y}function p(v){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,v,q):q(v)}function q(v){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,v,B):B(v)}function B(v){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var x=bookConfig.periodsConfigPath;x=x.replace("%periodicalId%",window.book_visit.periodicalId);c(x,v,u)}else u(v)}
function u(v){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,v):v&&v()}var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){return v.return(new Promise(function(x,y){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?x():window.runArticleEditor||window.inverseEditor?x():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(y=bookConfig.bookBaseURL)?(y.endsWith("/")||(y+="/"),c(y+"bookinfo.js",function(z){z&&z.response&&
(eval(z.response),window.book_visit=book_visit);b(function(){window.runArticleEditor=1;x()})},"","text","bookinfo")):b(function(){window.runArticleEditor=1;x()}):(window.runArticleEditor=1,x(),window.runArticleEditor&&delete window.runArticleEditor))}))})}
...
B=0;B<canvasData[b].resources.length;B++)if(1!=canvasData[b].resources[B].type)q++,q>=canvasData[b].resources.length&&k();else{var u=new Image;u.src=getResource(b,B);globalImages[b][B]=u;u.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
...
e&&e(c,c,k,b)};B.jumpToEnd()})},noneLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){h=$("<div style='width:100%;height:100%;background:"+bookConfig.pageBackgroundColor+";'></div>");e&&e(c,c,h,b);return k.return()})},jsLoad=function(b,c,d,e,f,g){var h,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){h=function(q,B){return!q||passwardType()&&bookConfig.excludeFrontPages&&B>parseInt(bookConfig.excludeFrontPages)&&!verifyPassward()?!1:
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),p.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},p.return();loadJavascript(c,function(q){var B=dataBase64Str(b,d,q);$("<img src='"+B+"'/>")[0].onload=function(){e&&e(B,c,this,b)}},function(){});
return p.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(!window.printLoadStack)return p.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(q){var B=q.toDataURL("image/png"),u=$("<img src='"+B+"'/>");u[0].onload=function(){e&&e(B,B,u,b)}}.bind(h));window.printLoadStack.push(m);return p.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),q.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),q.return();p=h;loadJavascript(k,function(B){var u=dataBase64Str(b,c,B);p.$image=$("<img src='"+
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),p=b.getContext("2d"),q=p.getImageData(0,0,f,g),B=p.createImageData(c,d);q=q.data;for(var u=B.data,r=0;r<d;r++)for(var v=0;v<c;v++){for(var x=4*(v+r*c),y,z=0,G=0,F=0,O=0,L=0,H=0,I=(r+.5)*k,K=Math.ceil((r+1)*k),M=Math.floor(r*k);M<K;M++){var W=Math.abs(I-(M+.5))/m,Z=(v+.5)*h;W*=W;for(var aa=Math.ceil((v+1)*h),T=Math.floor(v*h);T<aa;T++)if(y=Math.abs(Z-(T+.5))/l,y=
Math.sqrt(W+y*y),!(1<=y)){y=2*y*y*y-3*y*y+1;var U=4*(T+M*f);H+=y*q[U+3];G+=y;255>q[U+3]&&(y=y*q[U+3]/250);F+=y*q[U];O+=y*q[U+1];L+=y*q[U+2];z+=y}}u[x]=F/z;u[x+1]=O/z;u[x+2]=L/z;u[x+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
this.pdfLoadingTask.destroy(),this.pdfLoadingTask=null)}}),ImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=
...
function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));B.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&
...
25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,B){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,v=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(B=v(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(r*r-B*B):r-f*Math.sqrt(u*u-B*B));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,
...
var IssuuImageArrayLoadImage=Class({index:0,type:0,pageWidth:0,pageHeight:0,width:0,height:0,$image:null,imageURL:"",isMirrorSide:"",create:function(b,c,d,e,f,g,h,k,l){var m=this,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){m.index=b;m.type=d;m.i=l;m.callback=e;m.errorCallback=f;m.pageWidth=g;m.pageHeight=h;m.isMirrorSide=k;p=c;bookConfig.useTheAliCloudChart&&BookInfo.getBook().status_zoom&&(p=p.removeStartFrom("?"));m.imageURL=p;m.imageObject=new ImageObject;m.imageObject.alt(m.index);
m.imageObject.src(m.imageURL);m.imageObject.css({"z-index":0});m.$image=m.imageObject.$image;bookConfig.EnableRecognizeQRcodePressOnMobile&&m.imageObject.css({"-webkit-touch-callout":"default"});m.loaded=!1;m.$image[0].onload=function(){this.loaded=!0;this.callback&&this.callback(this.$image);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(m);m.$image[0].onerror=function(){this.loaded=!0;this.errorCallback&&this.errorCallback(this.$image)}.bind(m);
bookConfig.textSharpening&&(q="-webkit-optimize-contrast",_agent_.browser.firefox&&(q="-moz-crisp-edges"),_agent_.browser.opera&&(q="-o-crisp-edges"),m.$image.css({"image-rendering":q,"-ms-interpolation-mode":"nearest-neighbor"}));B.jumpToEnd()})},zoomIn:function(b){bookConfig.useTheAliCloudChart&&isPC()?this.switchLargeImage(b):(isPhone()||isPad())&&this.highDefinition()},zoomOut:function(b,c){bookConfig.useTheAliCloudChart&&isPC()?this.switchNormalImage(b,c):(isPhone()||isPad())&&this.resize()},
...
0;m=function(){l++;this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);p=function(r){l++;this.$images.removeElement(r);this.callback&&l==k.length&&this.callback(k,k,this.$images,this.index)}.bind(h);for(q=0;q<k.length;q++)B=-1<k[q].indexOf(".svg")?new IssuuImageArrayLoadSvg(b,k[q],c,m,p,e,f,g,q):new IssuuImageArrayLoadImage(b,k[q],c,m,p,e,f,g,q),h.$images.push(B.$image),h.loadArray.push(B);u.jumpToEnd()})},zoomIn:function(b){for(var c=0;c<this.loadArray.length;c++)this.loadArray[c].zoomIn&&
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,B){if(!b)return!1;var u=b.pageWidth,r=b.pageHeight,v=$.easing["easeInOut"+B],x=$.easing["easeOut"+B];B=x(null,p,g,b.toPoint.x-g,q);x=x(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(B=v(null,p,g,b.toPoint.x-g,q),x=bookConfig.FlipDirection?f*Math.sqrt(r*r-B*B):r-f*Math.sqrt(u*u-B*B));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:x}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){try{var m=1,p=1;m=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);for(c=0;c<b.length;c++){var q=this.pageArray[b[c]];if(q){var B=transformCSS({tran:l?l:{x:0,y:0},scale:{x:m,y:p},origin:g});this.isCoverPage(b[c])&&(q.tran=l?l:{x:0,y:0},q.scale={x:m,y:p},q.rotateY?(q.$page[0].style.removeProperty("transform-origin"),d=void 0,B=transformCSS({scale:{x:m,
y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,B=transformCSS({origin:g,scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(B);if(q.page.pageFlipShadow){var u=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(u)}}}return{x:m,y:p}}catch(r){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);
