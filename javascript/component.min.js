...
f={};for(h=0;h<a.length;f={$jscomp$loop$prop$page$3:f.$jscomp$loop$prop$page$3},h++)f.$jscomp$loop$prop$page$3=a[h],getPageDir(f.$jscomp$loop$prop$page$3,"normal").then(function(l){return function(m){var p=e,n=g;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),p=2*e,n=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$3).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$3,q,d.bind(b),
p,n)}):pageResourceLoad(l.$jscomp$loop$prop$page$3,"normal",d.bind(b),p,n)}}(f));k.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),h=new Image;h.crossOrigin="anonymous";h.onload=function(){var k,l,m,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(n){if(1==n.nextAddress)return n.setCatchFinallyBlocks(2),g.width=h.naturalWidth,g.height=h.naturalHeight,f.drawImage(h,0,0),n.yield(c.createWatermarkWithPageWatermark(h.naturalWidth,
...
!1;this.downloadButton.click(function(){var c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(b.restricted)return d.return();c=function(){var e,g,f,h,k,l,m,p,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(1==q.nextAddress)return b.verify=!0,e="","downloadAll"==b.downloadButton.downloadType&&(e=b.downloadconfig.pdf.url),"downloadCurrent"!=b.downloadButton.downloadType?q.jumpTo(2):q.yield(getPageDir(b.pageIndex,"normal"),3);2!=q.nextAddress&&(e=q.yieldResult);
...
l=$("<a href="+h.toDataURL("image/png")+' download="page'+b.pageIndex+'.png"></a>'),l[0].click();else{m="";"downloadCurrent"==b.downloadButton.downloadType&&(m=b.pageIndex+".jpg");"downloadAttachments"==b.downloadButton.downloadType&&(m=b.currentAttachmentName||"");if(location.protocol.match("file:"))return/^\/\//i.test(e)&&(e="https://"+e),window.open(e),q.return();if("downloadAll"==b.downloadButton.downloadType)return"English"==UserGroups&&(p=_get(htmlConfig,"meta.url","")||window.location.href,
e=e.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(p))),bookConfig.isEncryptionBook&&(n=BookRestrict.getRestrictToken(),e=appendParamToUrl(e,"code="+n)),window.open(e,"_blank"),q.return();if(isAndroid()&&isWeChat()||isPad())return window.open(e,"_blank"),q.return();if((!isPhone()&&!isPad()||_agent_.browser.safari)&&/fliphtml5|yunzhan365|anyflip|pubhtml5/.test(location.host))return l=$('<a download="'+m+'" target="_blank" href="'+e+'"></a>'),l[0].click(),q.return();new DownloadFile({url:e,downloadName:m,
...
3);2!=k.nextAddress&&(c=k.yieldResult);d=c;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$5:e.$jscomp$loop$prop$type$5},g++)f=a.itemArray[g],e.$jscomp$loop$prop$type$5=f.attr("data-type"),(h=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$5}}(e)))&&(-1<h.url.indexOf("javascript")?f.attr("onclick",h.url.remove("javascript:")+";return false;"):f.attr("href",h.url));k.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=
...
a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),c="<iframe frameborder='0'  width='240' height='210'  title='"+window.document.title+"' src='"+b+"' type='text/html' allowfullscreen='true' scrolling='no' marginwidth='0' marginheight='0'></iframe>",a.insertArea&&a.insertArea.val(c),share_url=b,a.analysisShare.refreshList(),k.yield(a.analysisShare.getList(),2);d=k.yieldResult;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$7:e.$jscomp$loop$prop$type$7},g++)f=a.itemArray[g],
e.$jscomp$loop$prop$type$7=f.attr("data-type"),(h=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$7}}(e)))&&(-1<h.url.indexOf("javascript")?f.attr("onclick",h.url.remove("javascript:")+";return false;"):f.attr("href",h.url));k.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=a.val(),copyToClipboard(a)}}},changeLanguage:function(){this.copy1.html(getLanguage("lblCopy","Copy"))},initColorConfig:function(){this.mainColor=
